...
urlpatterns = [
    ...
    path("sales/", SaleViewSet.as_view({"get": "sale_products"}), name="sale products"),
    ...
    path("comments/<int:pk>/",
         CommentViewSet.as_view({"get": "product_comments", "post": "comment_create", "patch": "comment_update", "delete": "comment_delete"}),
         name="comment create"),
