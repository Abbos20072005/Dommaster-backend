...
from apps.service.api.v1.client.serializers import PaginationSerializer
from apps.base.paginations.get_news import get_news_paginator
from apps.base.paginations.get_articles import get_articles_paginator
from apps.base.paginations.get_reviews import get_reviews_paginator
from apps.base.paginations.get_branches import get_branches_paginator
...
class PromocodeViewSet(ViewSet):
    ...
    def promocode_checker(self, request):
        ...
        promocode = Promocodes.objects.filter(code=serializer.validated_data.get("promocode").lower(), customer_id=request.user.id).first()
        if not promocode:
